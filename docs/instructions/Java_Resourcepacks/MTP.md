...
**当前说明书版本为V1.4.3，更新于2021/9/23**
**当前材质包版本为V1.4.1，更新于2021/7/31**

---

## 序言

Misaka’s Texture材质包 包括 256X、512X 和 Ultra 三个版本。
Ultra 版本包含了512x-2048x分辨率的贴图。
支持 **1.9-1.17** 版本（**1.17 版本存在兼容性问题，与 Forge 有关，不推荐使用**）
材质包包含1800个文件，基于**Java 端 1.12**游戏版本制作，覆盖度相当高。
**获取地址：**[**爱发电**](https://afdian.net/@Misaka9217)

**本教程为通用教程！实际上适用于大部分材质，使用别的材质时也可参考本项说明！**
...
1.12 包含了 1.12.2。
在 X.XX.X 中，版本号为三位数，第一位相同的情况下，第二位数字越大，版本越新，即，1.12 比 1.9 新，因为12 比 9 大。

如果你的游戏是 1.10.2，请使用括号内（1.9-1.12）的版本。
如果你的游戏是 1.15.2，请使用括号内（1.13-1.16）的版本。

...
- **光影包读取出现问题**
  ...
  - 若读取时提示`需要更新至 OptiFine Z1 版本` ，而 OptiFine 已发布的最新版本号**远低于**该版本时，意味着这个光影可能只支持 `1.16.5 G7 及以上`的 OptiFine。如果目前使用的是 `1.12.2` 客户端，可以尝试通过添加 [AdvancedShader](https://hypercol.github.io/science/shaders-base.html#%E8%BE%85%E5%8A%A9%E6%B8%B2%E6%9F%93%E6%A8%A1%E7%BB%84) 模组来解决问题。

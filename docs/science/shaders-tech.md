...
- 完全物理的光线追踪阴影和衔接阴影、光线追踪全局光照
  - Octray
![Octray.png](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/Octray.png "Octray")
  - 传统光影
![shader_1.png](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/shader_1.png "传统光影")
- 光源被阻挡形成的软阴影、正确的光照范围、光线在不同介质中的色散、不同光源不同颜色发光、光线混色
  - SEUS PTGI GFME
![SEUS_PTGI_GFME](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/SEUS_PTGI_GFME.png "SEUS PTGI GFME")
  - 传统光影
![shader_2.png](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/shader_2.png "传统光影")
- 可以反射/折射视野外的物体、多次反射/折射、真实的粗糙与金属质感
  - Kappa PT
    ![Kappa_PT](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/Kappa_PT.png "Kappa PT")
  - 传统光影
    ![shader_3.png](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/shader_3.png "传统光影")
...
![QQ截图20221025102723.png](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/QQ截图20221025102723.png "可见，即使是GTX系列也有着光追计算能力")
  - 图中最上面的一句话“Turing 架构相比 Volta 架构的光线追踪性能提升了六倍”
![QQ截图20221025103226.png](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/QQ截图20221025103226.png "图中最上面的一句话“Turing 架构相比 Volta 架构的光线追踪性能提升了六倍”")
![QQ截图20221025104558.png](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/QQ截图20221025104558.png "TITAN V 是唯一使用 Volta 架构的显卡，其并没有搭载光追核心")
...
- 此外，上文提到过，计算机图形学的光线追踪早在**上世纪**就已经由**数学科学组织提出**了，况且，在计算机领域最早使用的光线追踪属于**离线渲染**（例如C4D、Blender和电影渲染一类），直到近年硬件飞速发展，英伟达才首次将其推广到**在线渲染**领域。但即便如此，**英伟达并不是第一个在游戏界中应用光追**的厂商。例如 **SEUS 光影作者**早在**2017年**就已经开始**路径追踪测试，**并于**18年年初**在其 Patreon 上**发布第一个开发进度贴**，而**RTX 20系显卡首次发布在2018下半年**。
  ...
  ![图片](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/QQ截图20220220224158.png "援引自视频《BSL到底是不是光追？光追为mc带来了什么？》")
...
![图片](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/nv_mark_0.jpg "术语变化")
...
![图片](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/nv_mark_2.jpg)

- 译文：

>Nvidia营销部门显然不喜欢 "混合与全RT"，所以他们把混合渲染称为 "光线追踪"，然后把全RT称为 "路径追踪"......对这些术语的定义已经很薄弱了。

![图片](https://github.com/MineGraphCN/ImageLib/blob/main/MGCD/images/science/nv_mark_1.jpg)
